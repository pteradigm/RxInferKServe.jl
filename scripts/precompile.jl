...
# Register models
RxInferKServe.Models.register_builtin_models()

# Create some model instances
println("Precompiling model operations...")

instance1 = RxInferKServe.Models.create_model_instance("beta_bernoulli")
instance2 = RxInferKServe.Models.create_model_instance("linear_regression")
...
json_normal = RxInferKServe.Serialization.distribution_to_json(normal_dist)
json_beta = RxInferKServe.Serialization.distribution_to_json(beta_dist)
json_mvnormal = RxInferKServe.Serialization.distribution_to_json(mvnormal_dist)
...
# Clean up
RxInferKServe.Models.delete_model_instance(instance1.id)
RxInferKServe.Models.delete_model_instance(instance2.id)

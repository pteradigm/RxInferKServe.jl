...
const GRPC_SERVER_INSTANCE = Ref{Union{KServeV2.KServeV2GRPCServer.GRPCServer,Nothing}}(nothing)

# Start the server
function start_server(; host="127.0.0.1", port=8080, grpc_port=8081, enable_grpc=true, kwargs...)

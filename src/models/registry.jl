...
const GLOBAL_REGISTRY = ModelRegistry(
    Dict{String,Any}(),
    Dict{UUID,ModelInstance}(),
    ReentrantLock()
)

# Register a model definition
function register_model(name::String, model_fn::Function; 
...
function create_model_instance(model_name::String; 
